<div align="center">
  ...
  <p>
    <a href="https://github.com/LuanNeuwirthC/DailyReminder_Linux/releases/latest">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/versão-1.0.8-blue?style=flat-square">
  </p>
</div>
...
* **🎨 Personalização de Cores (Novo)**: Além dos temas pré-definidos, agora você pode escolher **qualquer cor hexadecimal** através do seletor nativo, deixando o app com a sua cara.

* **🔄 Auto-Update Integrado (Novo)**: O aplicativo verifica automaticamente o GitHub e notifica quando uma nova versão está disponível para download.

* **🧠 Agendamento Inteligente (Novo)**: Lógica aprimorada que evita disparos falsos ao editar o horário. Se você definir um horário que já passou hoje, o app entende automaticamente que o agendamento é para o dia seguinte.

* **UI Cyberpunk/Neon**: Interface moderna em modo escuro (ou claro/contraste) projetada para não cansar a vista.
...
* **Fluxo Automatizado**:
    1.  O alerta dispara no horário configurado (com som de notificação).
...
2. Baixe o arquivo `.zip` da versão mais recente (ex: `dailyreminder_installer_v1.0.8.zip`).
...
# Se você já tiver uma versão antiga, este comando irá atualizá-la automaticamente.
